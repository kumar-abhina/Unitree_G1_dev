...
if __name__ == "__main__":
    ...
    if user_input.lower() == 's':
        ...
        while True:
            ...
            # ask for FK of those joints
            T_L = arm_ik.get_end_effector_pose("left",  sol_q)   # 4×4 numpy
            T_R = arm_ik.get_end_effector_pose("right", sol_q)

            print("Left hand XYZ :", T_L[:3, 3])
            print("Right hand XYZ:", T_R[:3, 3])
